...
* [`haskell/cabal`](https://github.com/haskell/cabal) ⭐ 1,745 | 🐛 1,961 | 🌐 Haskell | 📅 2026-09-17: Official GitHub source
  repository.
...
* [`actions/cache`](https://github.com/actions/cache/blob/main/examples.md#haskell---cabal) ⭐ 5,551 | 🐛 241 | 🌐 TypeScript | 📅 2026-07-15:
...
* [Issue reporting](https://github.com/haskell/cabal/issues/new) ⭐ 1,745 | 🐛 1,961 | 🌐 Haskell | 📅 2026-09-17:
