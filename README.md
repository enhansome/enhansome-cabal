...
* [`haskell/cabal`](https://github.com/haskell/cabal) ⭐ 1,745 | 🐛 1,946 | 🌐 Haskell | 📅 2026-08-19: Official GitHub source
  repository.
...
* [`actions/cache`](https://github.com/actions/cache/blob/main/examples.md#haskell---cabal) ⭐ 5,513 | 🐛 237 | 🌐 TypeScript | 📅 2026-07-15:
...
* [`ghc-musl`](https://github.com/utdemir/ghc-musl) ⭐ 138 | 🐛 12 | 🌐 Shell | 📅 2024-02-03:
...
* [`cargo-cabal`](https://github.com/yvan-sraka/cargo-cabal) ⭐ 112 | 🐛 6 | 🌐 Rust | 📅 2026-08-16:
...
* [Issue reporting](https://github.com/haskell/cabal/issues/new) ⭐ 1,745 | 🐛 1,946 | 🌐 Haskell | 📅 2026-08-19:
