...
* [`haskell/cabal`](https://github.com/haskell/cabal) ⭐ 1,746 | 🐛 1,959 | 🌐 Haskell | 📅 2026-09-09: Official GitHub source
  repository.
...
* [`actions/cache`](https://github.com/actions/cache/blob/main/examples.md#haskell---cabal) ⭐ 5,544 | 🐛 240 | 🌐 TypeScript | 📅 2026-07-15:
...
* [`cargo-cabal`](https://github.com/yvan-sraka/cargo-cabal) ⭐ 112 | 🐛 6 | 🌐 Rust | 📅 2026-09-06:
...
* [Issue reporting](https://github.com/haskell/cabal/issues/new) ⭐ 1,746 | 🐛 1,959 | 🌐 Haskell | 📅 2026-09-09:
