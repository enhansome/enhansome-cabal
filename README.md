...
* [`haskell/cabal`](https://github.com/haskell/cabal) ⭐ 1,745 | 🐛 1,948 | 🌐 Haskell | 📅 2026-08-17: Official GitHub source
  repository.
...
* [`actions/cache`](https://github.com/actions/cache/blob/main/examples.md#haskell---cabal) ⭐ 5,514 | 🐛 237 | 🌐 TypeScript | 📅 2026-07-15:
...
* [Issue reporting](https://github.com/haskell/cabal/issues/new) ⭐ 1,745 | 🐛 1,948 | 🌐 Haskell | 📅 2026-08-17:
