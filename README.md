...
* [`haskell/cabal`](https://github.com/haskell/cabal) ⭐ 1,744 | 🐛 1,967 | 🌐 Haskell | 📅 2026-09-21: Official GitHub source
  repository.
...
* [`actions/cache`](https://github.com/actions/cache/blob/main/examples.md#haskell---cabal) ⭐ 5,558 | 🐛 240 | 🌐 TypeScript | 📅 2026-07-15:
...
* [Issue reporting](https://github.com/haskell/cabal/issues/new) ⭐ 1,744 | 🐛 1,967 | 🌐 Haskell | 📅 2026-09-21:
