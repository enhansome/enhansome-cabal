...
* [`haskell/cabal`](https://github.com/haskell/cabal) ⭐ 1,744 | 🐛 1,969 | 🌐 Haskell | 📅 2026-09-26: Official GitHub source
  repository.
...
***Backpack** is a feature that allows implementing mix-in libraries in Haskell.
...
* [Edward Z. Yang thesis](https://github.com/ezyang/thesis) ⭐ 38 | 🐛 0 | 🌐 TeX | 📅 2018-04-04
...
* [`streamy`](https://github.com/danidiaz/streamy) ⭐ 34 | 🐛 3 | 🌐 Haskell | 📅 2017-09-16:
...
* [`policeman` (by Kowainik)](https://github.com/kowainik/policeman) ⭐ 74 | 🐛 7 | 🌐 Haskell | 📅 2021-02-24:
...
* [`mafia`](https://github.com/haskell-mafia/mafia) ⭐ 138 | 🐛 34 | 🌐 Haskell | 📅 2019-12-02:
...
* [`cabal-clean`](https://github.com/andreasabel/cabal-clean) ⭐ 11 | 🐛 1 | 🌐 Haskell | 📅 2026-04-11:
...
* [`appveyor.yml` example](https://github.com/kowainik/tomland/blob/main/appveyor.yml) ⭐ 135 | 🐛 43 | 🌐 Haskell | 📅 2026-08-30:
...
* [`actions/cache`](https://github.com/actions/cache/blob/main/examples.md#haskell---cabal) ⭐ 5,559 | 🐛 241 | 🌐 TypeScript | 📅 2026-07-15:
...
* [`ghc-musl`](https://github.com/utdemir/ghc-musl) ⭐ 137 | 🐛 12 | 🌐 Shell | 📅 2024-02-03:
  Docker image with GHC+musl and Cabal for static executables.
* [`docker-ghc`](https://github.com/phadej/docker-ghc) ⭐ 12 | 🐛 3 | 🌐 Dockerfile | 📅 2022-02-01:
...
* [Heroku buildpack GHC](https://github.com/begriffs/heroku-buildpack-ghc) ⭐ 275 | 🐛 9 | 🌐 Shell | 📅 2019-05-27:
...
* [`autopack`](https://github.com/kowainik/autopack) ⭐ 33 | 🐛 5 | 🌐 Haskell | 📅 2022-04-04 (by Kowainik): Automatically discovers Haskell modules and populates `exposed-modules`.
...
* [`vim-syntax-haskell-cabal`](https://github.com/Twinside/vim-syntax-haskell-cabal) ⭐ 10 | 🐛 0 | 🌐 VimL | 📅 2015-07-07:
  Cabal syntax highlighting plugin for Vim.
* [Haskell IDE Setup with cabal and nix](https://github.com/shivamashtikar/haskell-setup) ⭐ 8 | 🐛 1 | 🌐 Vim script | 📅 2019-11-04:
  Haskell setup for vscode with cabal and nix.
* [`vim-cabal-indent`](https://github.com/h-youhei/vim-cabal-indent) ⭐ 2 | 🐛 1 | 🌐 Vim script | 📅 2017-03-11:
...
* [Issue reporting](https://github.com/haskell/cabal/issues/new) ⭐ 1,744 | 🐛 1,969 | 🌐 Haskell | 📅 2026-09-26:
