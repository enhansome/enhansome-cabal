...
* [`haskell/cabal`](https://github.com/haskell/cabal) ⭐ 1,747 | 🐛 1,962 | 🌐 Haskell | 📅 2026-09-02: Official GitHub source
  repository.
...
* [`actions/cache`](https://github.com/actions/cache/blob/main/examples.md#haskell---cabal) ⭐ 5,531 | 🐛 240 | 🌐 TypeScript | 📅 2026-07-15:
...
* [Issue reporting](https://github.com/haskell/cabal/issues/new) ⭐ 1,747 | 🐛 1,962 | 🌐 Haskell | 📅 2026-09-02:
