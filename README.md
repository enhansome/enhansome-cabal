...
* [`haskell/cabal`](https://github.com/haskell/cabal) ⭐ 1,743 | 🐛 1,955 | 🌐 Haskell | 📅 2026-08-11: Official GitHub source
  repository.
...
* [`actions/cache`](https://github.com/actions/cache/blob/main/examples.md#haskell---cabal) ⭐ 5,512 | 🐛 237 | 🌐 TypeScript | 📅 2026-07-15:
...
* [`cargo-cabal`](https://github.com/yvan-sraka/cargo-cabal) ⭐ 112 | 🐛 6 | 🌐 Rust | 📅 2026-08-09:
...
* [Issue reporting](https://github.com/haskell/cabal/issues/new) ⭐ 1,743 | 🐛 1,955 | 🌐 Haskell | 📅 2026-08-11:
